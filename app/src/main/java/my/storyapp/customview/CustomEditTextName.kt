...
class CustomEditTextName @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) : AppCompatEditText(context, attrs), View.OnTouchListener {
        ...
        addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                ...
                if (!(s != null && s.length > 0)) {
                    error = ContextCompat.getString(context, R.string.forbidden_reason_empty)
                    isNameValid = false
                }
                else {
                    isNameValid = true
